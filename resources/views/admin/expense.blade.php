...
<div class="card">
    ...
    <div class="card-body">
        <input type="text" class="form-control search-input" placeholder="Cari pengeluaran..." id="search" onkeyup="filterExpenses()">
        <input type="date" class="form-control search-input" id="searchDate" oninput="filterExpensesByDate()">
        ...
        <table class="table table-striped" id="expenseTable">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center">Tidak ada pengeluaran ditemukan.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
